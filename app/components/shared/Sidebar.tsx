                ...
                <div>
                  <div className="-mx-6 px-6 py-4">
                    ...
                    <a href="#" title="home">
                      ...
                      <Image src="https://tailus.io/sources/blocks/stats-cards/preview/images/logo.svg" className="w-32" alt="tailus logo"  width={30} height={30}/>
                    </a>
                  </div>
        
                  <div className="mt-8 text-center">
                    {/* Next/Image */}
                    <Image src="https://tailus.io/sources/blocks/stats-cards/preview/images/second_user.webp" alt="User profile picture" width={40} height={40} className="w-10 h-10 m-auto rounded-full object-cover lg:w-28 lg:h-28"/>
